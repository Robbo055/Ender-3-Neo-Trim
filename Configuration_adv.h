...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_TIMEOUT_SEC (30)    // (seconds) Time without extruder movement to trigger protection
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 1000*60, 100*60, 4*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
